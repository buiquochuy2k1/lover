const textConfig = {
  text1: 'Hé lô Khánh Trân!',
  text2: 'Anh có điều này muốn hỏi bé nhưng nhớ phải trả lời thật lòng nhaaa.',
  text3: 'Bé yêu anh có phải không nào ._.',
  text4: 'Nếu bé ko trả lời mà thoát ra tức là muốn làm vợ anh rùi đó nha :v',
  text5: 'Anh mơ à???',
  text6: 'Yêu ơi là yêu <3',
  text7: 'lí do bé iu anh đi :vvvv',
  text8: 'Gửi cho anh <3',
  text9: 'Vì anh đẹp try vlllll',
  text10: 'Anh biết mà ^^ Yêu bé <3',
